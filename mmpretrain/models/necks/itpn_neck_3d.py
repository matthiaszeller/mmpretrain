...
from .itpn_neck import PatchSplit, iTPNPretrainDecoder

@MODELS.register_module()
class iTPNPretrainDecoder3D(iTPNPretrainDecoder):
    ...
    def __init__(self,
        ...
        if reconstruction_type == 'pixel':
            ...
            num_patches = torch.prod(torch.tensor(self.patch_resolution)) * self.n_slice
