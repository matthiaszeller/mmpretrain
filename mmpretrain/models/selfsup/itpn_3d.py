...
from mmpretrain.models.backbones.hivit import BlockWithRPE, PatchMerge
from mmpretrain.models.backbones.hivit_3d import HiViT3D
from mmpretrain.registry import MODELS
from mmpretrain.structures import DataSample
from .base import BaseSelfSupervisor
from ..utils.position_encoding import build_3d_sincos_position_embedding


@MODELS.register_module()
class iTPNHiViT3D(HiViT3D):
    ...
    def forward_pixel(
        ...
        if mask is None or False:
            ...
            x = x[..., 0, 0, :]
            if self.ape:
                pos_embed = self.interpolate_pos_encoding(self.pos_embed, H, W)
